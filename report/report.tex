...
% multiiplexer_8_1_4b has 8 inputs, 1 output, and each io is 5 bits (name may need to change to 5b)
...
% TODO: Add justriciation of selectable text override <-- justification? - Boston
